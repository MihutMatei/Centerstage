...
import org.firstinspires.ftc.teamcode.common.drive.geometry.Vector2D_custom;
...
public class Pose extends Point {
    ...
    public Pose(Vector2D_custom vec, double heading) {
    ...
    public Vector2D_custom toVec2D() {
        return new Vector2D_custom(x, y);
    }
