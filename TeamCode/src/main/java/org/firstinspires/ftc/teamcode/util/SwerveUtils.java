...
public class SwerveUtils {
    ...
    public SwerveUtils(HardwareMap hardwareMap)
    {
    ...
    public void set_servos_power(double v1, double v2, double v3,double v4){
        frontLeftServo.setPower(v1);
        frontRightServo.setPower(v2);
        backLeftServo.setPower(v3);
        backRightServo.setPower(v4);
    }
    public void set_motors_power(double v1, double v2, double v3,double v4){
